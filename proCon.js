...
//начало начал
const option1 = prompt('Между чем (1) и чем (2) ты не можешь решиться? Напиши сейчас свое первое (1) чем. Например если ты не можешь решить купить Дом или Яхту "купить Дом"');
